...
export async function POST(req) {
  try {
    ...
    const { model, endpoint, prompt, aspect_ratio, duration, resolution, quality, mode, image_url, images_list } = body;
    ...
    const generation = await prisma.generation.create({
      data: {
        ...
        prompt: prompt || "",
        params: { aspect_ratio, duration, resolution, quality, mode, image_url, images_list },
        status: "pending",
        creditsUsed: cost,
      },
    });
