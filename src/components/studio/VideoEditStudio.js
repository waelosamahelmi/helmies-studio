...
/* ── Build video edit/extend model list ── */
  ...
  const inspector = (
    <div className="v6-control-stack">
      <div className="v6-panel-title">
        <h3>Status</h3>
        <span className={`v6-status${loading ? " v6-processing" : prompt && videoUrl ? "" : " v6-failed"}`}>
          {loading ? "Processing" : prompt && videoUrl ? "Ready" : "Incomplete"}
        </span>
      </div>
  ...
  const center = (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", minHeight: 0 }}>
      <StageArea
        ...
        toolLabel="Video Edit Studio"
        toolDesc="Upload a source clip, describe how to edit it, and pick a model. Restyle scenes, extend clips, or transform footage."
        toolIcon={<IconVideo />}
